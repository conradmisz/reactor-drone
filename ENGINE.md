...
| `ecs/systems/line_mesh_math.hpp` | v3 Tier 5 (D198): pure ribbon geometry — miter joins (width-preserving, hairpin-clamped), strip triangulation, arc-length UVs |
| `tests/unit/test_line_mesh_math.cpp` | Its tests |
